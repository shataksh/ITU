...
set title "Doba nez uzivatel po startu kliknul na prave dolni tlacitko [bez animaci]"
set xlabel "uzivatel"
set ylabel "sekundy"
set yrange [0:15]
#set size 0.5,0.5
...
#plot "with_anim.dat"
plot "without_anim.dat" using 1:2 with boxes
